...
export const listUsers = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`https://procommerce.onrender.com/api/users`, config);
...
export const deleteUser = (id) => async (dispatch, getState) => {
  try {
    ...
    await axios.delete(`https://procommerce.onrender.com/api/users/${id}`, config);
...
export const updateUser = (user) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(`https://procommerce.onrender.com/api/users/${user._id}`, user, config);
